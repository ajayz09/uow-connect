...
public class AddPostDialog extends DialogFragment implements View.OnClickListener, DialogInterface {
    ...
    public View onCreateDialogView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.forum_dialog_add_post, container); // inflate here
    }
